...
{{--                                                    aqui esta el nombre para tomar los datos--}}
                                                    <input type="file" name="name" id="input-picture" required>
                                                </span>
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        {!! Form::select('category_id',$category,null,['class'=>"selectpicker show-tick ", $errors->has('category_id') ? ' is-invalid' : '' ,
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-7">
                                        <div
                                            ...
                                            <textarea cols="6" rows="2" name="content" id="input-observation"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div
                                            ...
                                            <label for="input-tags"
                                                   class="bmd-label-floating">{{ __('') }}</label>
                                            {!! Form::select('tags[]',$tag,null,['class'=>"selectpicker show-tick  ", 'multiple' ,$errors->has('tags') ? ' is-invalid' : '' ,
                                    ...
                                    <!--    Conductor    -->
                                        ...
                                        <div
                                            ...
                                            {!! Form::select('status',['publicado'=>'publicado','inactivo'=>'inactivo','borrador'=>'borrador'],null,['class'=>"selectpicker show-tick ", $errors->has('status') ? ' is-invalid' : '' ,
